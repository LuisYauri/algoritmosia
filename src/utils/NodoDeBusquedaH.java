...
public class NodoDeBusquedaH implements Comparable<NodoDeBusquedaH>
{
    ...
    final private NodoDeBusquedaH padre;
    ...
    @Override
    public int compareTo(NodoDeBusquedaH y) {
//        NodoDeBusqueda y = (NodoDeBusqueda) otro;
        if(this.costoHeu > y.costoHeu)        return 1;
        else if( this.costoHeu < y.costoHeu)  return -1;
        else                            return 0;
    }
}
